...
bool pfSkel(
    ...
    std::cout << "- - > PFS-1: Reading volume data..." << std::endl;
#ifdef _DEBUG
    ...
    std::cout << "- - > PFS-2: Make solid volume..." << std::endl;
#ifdef _DEBUG
    ...
    std::cout << "- - > PFS-3: Calculating high curvature boundary points - NOT DONE" << std::endl;
#ifdef _DEBUG
...
*/
    ...
    if(vfInFile == NULL) {
        ...
        //
        std::cout << "- - > PFS-4: Placing charges outside the object" << std::endl;
#ifdef _DEBUG
        ...
        //
        std::cout << "- - > Phase 5: Calculating potential field..." << std::endl;
#ifdef _DEBUG
    ...
    //
    std::cout << "- - > Pahse 6: Detecting citical points..." << std::endl;
#ifdef _DEBUG
    ...
    //
    std::cout << "- - > Phase 7: Detecting skeleton points..." << std::endl;
#ifdef _DEBUG
    ...
    pfSkelCommand cmd;
    std::cout << "- - > Get level skeleton" << std::endl;
    ...
    std::cout << "- - > Save the segments array" << std::endl;
    ...
    std::cout << "- - > Compute level 2 skeleton" << std::endl;
    ...
    while(it < 3) {
        ...
        std::cout << "- - > Get the skeleton" << std::endl;
        //
        // get the skeleton
        //
        GetLevel2Skeleton(force, L, M, N, HDPts, numHDPts, Skel);

        std::cout << "- - > Change the parameters" << std::endl;
    ...
    if((*pfnChangeParams)(Skel, &cmd, other)) {
      ...
      stop = true;
        ...
        std::cout << "- - > Return to level1 skeleton" << std::endl;
    ...
    std::cout << "- - > Free the memory wasted" << std::endl;
...
*/
    ...
    std::cout << "- - > Free the allocated memory" << std::endl;
